...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-[#0a0b0e]">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-36 sm:py-40 lg:py-48">
        <div className="max-w-4xl">
          ...
          <div className="animate-fade-up-d2 mt-8 sm:mt-10">
          ...
          <div className="animate-fade-up-d3 mt-10 sm:mt-12 flex flex-wrap items-center gap-5 sm:gap-7">
            <a
              href="#departments"
          ...
          <div className="animate-fade-up-d4 mt-12 sm:mt-14 lg:mt-16 flex flex-wrap gap-10 sm:gap-14 lg:gap-20">
            {[

      ...
      <div className="relative z-10 max-w-[1831px] mx-auto px-4 sm:px-6 lg:px-10 py-16 sm:py-20 lg:py-24 min-h-screen flex flex-col justify-center">
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8">
          <div className="relative">
            ...
            <span className="absolute -bottom-4 right-0 lg:right-auto lg:left-full lg:ml-2 lg:-bottom-2 font-condiment text-neon text-[36px] sm:text-[48px] md:text-[60px] lg:text-[68px] -rotate-1 mix-blend-exclusion opacity-90 normal-case whitespace-nowrap">
              Community
            </span>
          </div>
        ...
        <div className="flex flex-row justify-between mt-16 lg:mt-24 gap-8">
          <div className="flex flex-col gap-6 flex-1">
            <p className="font-mono text-[14px] uppercase text-[#010828] lg:text-cream/10 leading-relaxed max-w-[266px]">
          ...
          <div className="hidden lg:flex flex-col gap-6 flex-1">
            <p className="font-mono text-[14px] uppercase text-cream/10 leading-relaxed max-w-[266px]">
              Build. deploy. innovate. collaborate. explore. create. lead.
            </p>
            <p className="font-mono text-[14px] uppercase text-cream/10 leading-relaxed max-w-[266px]">
              Code. design. analyze. market. ship. repeat. grow.

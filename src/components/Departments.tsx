...
const departments = [
  {
    name: "Development",
    desc: "Web, mobile, and software engineering. We build the digital future, one commit at a time.",
    accent: "#ff4500",
    members: "30+",
  },
  {
...
export default function Departments() {
  return (
    <section id="departments" className="relative py-24 sm:py-28 lg:py-32 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-12 sm:mb-14">
          ...
          <a
            href="#contact"
            className="hidden sm:inline-flex items-center gap-1.5 border border-accent/50 text-accent px-5 py-2.5 text-[10px] tracking-widest uppercase font-inter font-bold hover:bg-accent/10 transition-all"
          >
            Join a Department
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
          {departments.map((dept) => (
            ...
            >
              ...
              <h3 className="font-anton text-white text-xl sm:text-2xl uppercase tracking-tight mb-3 group-hover:text-accent transition-colors">
                {dept.name}
              </h3>
              <p className="font-inter text-[13px] text-[#999] leading-relaxed mb-5">
                {dept.desc}
              </p>
              <div className="flex items-center justify-between pt-4 border-t border-white/5">
                <span className="text-[10px] text-[#666] font-inter tracking-wider">
        ...
        <div className="mt-6 sm:hidden text-center">
          <a
            href="#contact"
            className="inline-flex items-center gap-1.5 border border-accent/50 text-accent px-5 py-3 text-[10px] tracking-widest uppercase font-inter font-bold"
          >
            Join a Department
            <ArrowUpRight size={12} />
          </a>
